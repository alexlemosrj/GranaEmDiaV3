...
## 1. Execute o SQL no Editor SQL do Supabase

Copie e cole o seguinte código no Editor SQL do seu projeto Supabase:
...
2. Ative "Enable email confirmations" se desejar
3. Configure o Site URL para: `http://localhost:8080` (desenvolvimento) ou sua URL de produção
...
2. Criar transações e metas
3. Todos os dados serão salvos no Supabase
4. Os dados são sincronizados em tempo real
